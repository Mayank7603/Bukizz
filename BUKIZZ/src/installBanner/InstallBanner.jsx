...
function InstallBanner() {
	return (
		<section className=" mainBox backdrop-opacity-5 h-[520px] w-[85%] lg:h-[255px]   items-center justify-center lg:pt-0 rounded-2xl overflow-hidden flex flex-col lg:flex-row mx-auto  ">
			<div className="w-auto h-full overflow-hidden  top-0 ">
				...
				/>
				<img
					className="fixed left-[0px] top-[3px] w-70 lg:h-64 h-96 r1 "
					src={rect1}
					alt="Rect1"
				/>
			</div>
			...
			<div className="   justify-center items-center hidden lg:inline-block">
				<div className="flex gap-4 justify-center w-[90%] lg:w-full ml-4 lg:m-0">
					<img
						className=""
						src={mobile}></img>
				</div>
